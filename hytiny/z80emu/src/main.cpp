...
static void emulate (const void* rom, int len)
{
    ...
    // additional patch, this is need to set the stack lower (mem is only 16 KB)
    context.memory[0x113] = 0x21;   /* LD HL, N */
    context.memory[0x114] = 0x00;
    context.memory[0x115] = 0x40;
