...
namespace USB {
    ...
    void setConfig () {
        ...
        MMIO32(DIEPTXF1 + 0) = (128/4<<16) | (512+128);  // 128b for TX ep1
        MMIO32(DIEPTXF1 + 4) = (128/4<<16) | (512+256);  // 128b for TX ep2
        MMIO32(DIEPTXF1 + 8) = (128/4<<16) | (512+384);  // 128b for TX ep3
